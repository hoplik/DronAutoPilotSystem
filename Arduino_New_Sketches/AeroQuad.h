...
/*Подключаем второй порт для связи нано с шилдом
 * temporary disabled
#define SERIAL1_PRINT		SERIAL1_PORT.print
#define SERIAL1_PRINTLN		SERIAL1_PORT.println
#define SERIAL1_AVAILABLE	SERIAL1_PORT.available
#define SERIAL1_READ		SERIAL1_PORT.read
#define SERIAL1_FLUSH		SERIAL1_PORT.flush
#define SERIAL1_BEGIN		SERIAL1_PORT.begin
*/
...
/*
	OnBoardPilotSystem global declaration
*/
byte OnBoardPilotSystem = OFF; // Инициализация автопилота
